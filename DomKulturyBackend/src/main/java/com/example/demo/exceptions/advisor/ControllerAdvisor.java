...
public class ControllerAdvisor extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(RoomIsUsedInEventException.class)
    public ResponseEntity<Object> handleRoomIsUsedInEventException(RoomIsUsedInEventException ex, WebRequest request) {
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("message", ex.getMessage());
    ...
    public ResponseEntity<Object> handleRoomExistsException(RoomExistsException ex, WebRequest request) {
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("message", ex.getMessage());
    ...
    @ExceptionHandler(PeselInUseException.class)
    public ResponseEntity<Object> handlePeselInUseException(PeselInUseException ex, WebRequest request) {
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("message", ex.getMessage());
    ...
    @ExceptionHandler(UserAssignedToSubjectException.class)
    public ResponseEntity<Object> handleUserAssignedToSubjectException(UserAssignedToSubjectException ex, WebRequest request) {
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("message", ex.getMessage());
