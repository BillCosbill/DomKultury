...
const routes: Routes = [
  ...
  {path: 'subject/:id/lesson/:id2', component: LessonDetailsComponent, pathMatch: 'full', canActivate: [TeacherguardService]},
  {path: 'subject/:id/lesson/:id2/attendance', component: LessonDetailsAttendanceComponent, pathMatch: 'full', canActivate: [TeacherguardService]},
